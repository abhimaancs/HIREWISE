            ...
            <>
              {publicLinks.map(({ href, label }) => (
                <Link key={href} href={href} style={navLink(href)}
                  onMouseEnter={e => { if (!isActive(href)) (e.currentTarget as HTMLElement).style.color = 'var(--text-primary)' }}
                  onMouseLeave={e => { if (!isActive(href)) (e.currentTarget as HTMLElement).style.color = 'var(--text-secondary)' }}>
        ...
        <div className="hw-desktop-links" style={{ gap: 8, alignItems: 'center' }}>
          ...
          {userRole ? (
            ...
            <button onClick={handleSignOut} style={{
              ...
              onMouseLeave={e => { (e.currentTarget as HTMLElement).style.color = 'var(--text-secondary)'; (e.currentTarget as HTMLElement).style.borderColor = 'rgba(255,255,255,0.08)' }}
              aria-label="Sign out"
            >
              <LogOut size={13} />
            </button>
        ...
        <>
          <Link href="/login">
            <button style={{
              ...
              onMouseLeave={e => { (e.currentTarget as HTMLElement).style.color = 'var(--text-secondary)'; (e.currentTarget as HTMLElement).style.borderColor = 'rgba(255,255,255,0.1)' }}
            >
              Log in
            </button>
          </Link>
